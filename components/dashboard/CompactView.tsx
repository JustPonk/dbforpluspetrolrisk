...
export default function CompactView({ selectedResidence, currentRiskLevel }: CompactViewProps) {
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-[200px_1fr_200px] gap-3 min-h-[360px]">
      ...
      <div className="flex flex-col gap-3 order-1 lg:order-2">
        ...
        <motion.div
          ...
          className="bg-slate-800 rounded-xl shadow-xl border border-slate-700 h-48 md:h-64 lg:h-80"
        >
        ...
        <motion.div
          ...
          className="bg-slate-800 rounded-xl shadow-xl border border-slate-700 h-48 md:h-[215px]"
        >
          <Speedometer 
